/*1317809651,169569404,JIT Construction: v453330,en_US*/
...
if(!window.FB)window.FB={
    ...
    copy:function(d,c,b,e){
        for(var a in c)if(b||typeof d[a]==='undefined')d[a]=e?e(c[a]):c[a];return d;
    },
    create:function(c,h){
...
FB.provide('Array',{
    indexOf:function(a,c){
        ...
        var d=a.length;
        if(d)for(var b=0;b<d;b++)if(a[b]===c)return b;return -1;
    },
    merge:function(c,b){
        for(var a=0;a<b.length;a++)if(FB.Array.indexOf(c,b[a])<0)c.push(b[a]);return c;
    },
    filter:function(a,c){
        var b=[];
        for(var d=0;d<a.length;d++)if(c(a[d]))b.push(a[d]);return b;
    },
    keys:function(c,d){
        var a=[];
        for(var b in c)if(d||c.hasOwnProperty(b))a.push(b);return a;
    },
    map:function(a,d){
        var c=[];
...
FB.provide('Canvas',{
    ...
    getPageInfo:function(a){
        ...
        var b=FB.XD.handler(function(e){
            for(var f in FB.Canvas._pageInfo)if(e[f])FB.Canvas._pageInfo[f]=e[f]|0;a&&a(FB.Canvas._pageInfo);
        },d,true);
        var c={
            channelUrl:b,
            frame:window.name
    ...
    _hideFlashCallback:function(f){
        ...
        for(var d=0;d<a.length;d++){
            ...
            var c=false;
            for(var e=0;e<b.childNodes.length;e++)if(b.childNodes[e].nodeName=="PARAM"&&b.childNodes[e].name=="wmode")if(b.childNodes[e].value=="opaque"||b.childNodes[e].value=="transparent")c=true;if(!c)if(f.state=='opened'){
...
FB.provide('Dom',{
    ...
    getByClass:function(b,c){
        ...
        for(var e=0,f=a.length;e<f;e++)if(this.containsCss(a[e],b))d[d.length]=a[e];return d;
    },
...
FB.subclass('Data.Query','Waitable',function(){
    ...
    parse:function(a){
        ...
        for(var c=1;c<a.length;c++)if(FB.Type.isType(a[c],FB.Data.Query))a[c].hasDependency=true;return this;
    },
    toFql:function(){
...
FB.provide('TemplateUI',{
    ...
    paramsAllowTemplate:function(c,a){
        ...
        for(var d in b[c])if(a[d])return false;return !FB.TemplateUI.willWriteOnGet(c,a);
    },
...
FB.subclass('XFBML.Facepile','XFBML.IframeWidget',null,{
    ...
    setupAndValidate:function(){
        ...
        this.clear();
        for(var a in this._extraParams)this._attr[a]=this._extraParams[a];return true;
    },
...
FB.provide('Insights',{
    impression:function(e,a){
        ...
        for(var d in e)f.push(encodeURIComponent(d)+'='+encodeURIComponent(e[d]));g+='?'+f.join('&');
        if(a)c.onload=a;
        c.src=g;
    }
});
...
FB.subclass('XFBML.LoginButton','XFBML.ButtonElement',null,{
    ...
    getButtonMarkup:function(){
        ...
        if(!this._attr.registration_url){
            ...
            case 'notConnected':case 'not_authorized':
...
FB.provide("", {
    "_domain":{
        "api":"https:\/\/api.me.com\/",
        "api_read":"https:\/\/api-read.me.com\/",
        "cdn":"http:\/\/static.ak.fbcdn.net\/",
        "cdn_foreign":"http:\/\/connect.facebook.net\/",
        "graph":"https:\/\/graph.me.com\/",
        "https_cdn":"https:\/\/s-static.ak.fbcdn.net\/",
        "https_staticfb":"https:\/\/s-static.ak.facebook.com\/",
        "https_www":"https:\/\/www.facebook.com\/",
        "staticfb":"http:\/\/static.ak.facebook.com\/",
        "www":"http:\/\/www.me.com\/",
        "m":"http:\/\/m.me.com\/",
        "https_m":"https:\/\/m.me.com\/"
    },
    "_locale":"en_US",
    "_localeIsRtl":false
}, true);
FB.provide("Flash", {
    "_minVersions":[[10,0,22,87]],
